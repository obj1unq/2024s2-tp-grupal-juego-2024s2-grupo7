...
const mesada3 = new Mesada(position = game.at(86.8,63.5))
const horno2 = new Horno(position = game.at(102,63.5)) 
//queso factory game.at(116, 63.5)


const mesada4 = new Mesada(position = game.at(6.5,44))
const mesada5 = new Mesada(position = game.at(21.7,44))
